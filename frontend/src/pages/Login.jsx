...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flexitems-center'>
      <div className='flex flex-col mt-10 w-1/3 gap-3 m-auto items-start p-10 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
